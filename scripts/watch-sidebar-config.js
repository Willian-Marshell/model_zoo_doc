...
function regenerateConfig() {
  ...
  console.log('\nFile change detected. Regenerating config...\n');
...
function main() {
  ...
  console.log(
    '\nWatcher started. Changes to _sidebar_scope.json or Markdown front matter (including i18n/en/.../current) will regenerate the config file.\n',
  );
